...
这些图是教材里的**讲解示意图**，不是流程图，也不是 MiniShop 运行截图。第 1～22 章每章至少有一张，嵌在对应概念旁边。全书脊柱图：`ch01-formula`（测试 = 观察 + 判定 + 证据）。2026-09-10 教学审查后新增 `ch03-exploratory`、`ch13-four-shapes`、`ch19-cross-check`。
